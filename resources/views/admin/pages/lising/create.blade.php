    ...
    <main>
        <div class="container-fluid">
            ...
            <ol class="breadcrumb mb-4">
                ...
                <li class="breadcrumb-item active">Lizinq</li>
            </ol>
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="card shadow-lg border-0 rounded-lg">
                        <div class="card-body">
                            <form method="post" action="{{route('admin.lising.store')}}" enctype="multipart/form-data">
                                @csrf
                                <div class="form-row">
                                    <div class="col-md-12">
                                ...
                                @if($time)
                                    @foreach($time as $t)
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 mt-4">
                                                <div class="form-group"><label class="small mb-1" for="inputFirstName"><strong>GPS məbləği:</strong></label><input class="form-control py-4" type="text" placeholder="Gps məbləğini daxil edin" name="gps[{{$t}}]"></div>
                                            </div>
                                        </div>
                                    @endforeach
                                @endif
